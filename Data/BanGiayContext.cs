...
public partial class BanGiayContext : DbContext
{
    ...
    public virtual DbSet<HienThiHoaDon_cxl> HienThiHoaDon_cxls { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HienThiHoaDon_cxl>(entity =>
        {
            entity.HasKey(e => e.MaHoadon);
        ...
        modelBuilder.Entity<Sanpham>(entity =>
        {
            ...
            entity.Property(e => e.NhomGiay)
               .HasMaxLength(10)
               .IsUnicode(false)
               .HasColumnName("NhomGiay");
